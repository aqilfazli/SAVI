// Map versioned import strings used in the codebase to their canonical package names
// This avoids large-scale mass-replacement in source files and keeps types intact.
